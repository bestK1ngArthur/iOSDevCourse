...
- (void)viewDidLoad {
    ...
    // Set general info
    self.universityLabel.text = self.student.university.name;
    self.photoView.image = [UIImage imageNamed:self.student.photo];
    
    // Set score info
    self.scoreLabel.text = [NSString stringWithFormat:@"%1.2f", [self.student.score floatValue]];
    if ([self.student.score floatValue] == 4) {
        self.scoreView.image = [UIImage imageNamed:@"scoreViewPurpleReversed"];
    } else if ([self.student.score floatValue] >= 3.4) {
        self.scoreView.image = [UIImage imageNamed:@"scoreViewGreenReversed"];
    } else if (([self.student.score floatValue] < 3.4) && ([self.student.score floatValue] >= 2.5)) {
        self.scoreView.image = [UIImage imageNamed:@"scoreViewYellowReversed"];
    } else {
        self.scoreView.image = [UIImage imageNamed:@"scoreViewRedReversed"];
    }
...
- (void)updateOrientation {
    ...
    if (UIDeviceOrientationIsPortrait([UIDevice currentDevice].orientation)) {
        ...
        self.fullNameLabel.text = self.student.firstName;
        
    } else {
        
        self.addressLabel.text = [self.student fullAddress];
